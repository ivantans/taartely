    ...
    <div class="container">
        ...
        <div>
            ...
            <table>
                ...
                <tr>
                    <th>Status</th>
                    <td>Pesanan sedang di proses</td>
                </tr>
            ...
            <h5>Pesanan sedang di proses oleh user. pesanan akan dikirim pada tanngal {{ $order->due_date }}</h5>
            
            <div class="text-center mt-5">
                <a style="color:white" href="http://127.0.0.1:8000/">Pergi ke taartely</a>
            </div>
        </div>
    </div>
</div>
