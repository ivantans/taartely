    ...
    <div class="container">
        ...
        <div>
            ...
            <table>
                ...
                <tr>
                    <th>Status</th>
                    <td>Diterima oleh penjual | perlu di bayar sebelum {{ Carbon\Carbon::parse($order->created_at)->addHours(12) }} </td>
                </tr>
            ...
            <h5>Pesanan ini belum dibayar, silahkan lakukan proses pembayaran dan mengupload bukti pembayaran</h5>
