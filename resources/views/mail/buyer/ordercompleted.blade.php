...
<body>
    ...
    <div class="container">
        ...
        <div>
            ...
            <h5>Pesanan sudah selesai, bersiap-siaplah untuk menerima pesanan</h5>
            
            <div class="text-center mt-5">
                <a style="color:white" href="http://127.0.0.1:8000/orders?status=completed">Pergi ke orders</a>
            </div>
        </div>
    </div>
</div>
